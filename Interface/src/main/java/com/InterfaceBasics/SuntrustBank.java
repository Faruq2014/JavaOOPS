...
public class SuntrustBank implements FDIC{
 ...
 */
	...
	public static void main(String[] args) {
		FDIC fdic=new SuntrustBank();
		fdic.bname("bankName"); //
		fdic.checkingAccount(null);// string, even if you put null/default value in the constructor it call the method argument.
		fdic.savingAccount("savingName");
		fdic.LoaninterestRate(0);// float, even if you put 0/default value in the constructor it call the method argument.
	}
	...
	public void LoaninterestRate(float interest) {
		System.out.println("saving account interest rate is "+FDIC.interestRate+"%");
